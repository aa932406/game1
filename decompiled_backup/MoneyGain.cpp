// Decompiled methods for class: MoneyGain
// Source: gameserver.cc
// Total methods: 3

#####################################
void __cdecl MoneyGain::~MoneyGain(MoneyGain *const this)
{
  MoneyGain::~MoneyGain(this);
  operator delete(this);
}


#####################################
int32_t __cdecl MoneyGain::effect(
        MoneyGain *const this,
...
#####################################
bool __cdecl MoneyGain::parseEffect(MoneyGain *const this, int32_t id, const std::string *const strEffect)
{
  std::string *v3; // rax
  const char *v4; // rax
  std::string *v5; // rax
