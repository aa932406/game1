...
#define CLEAR_CD_VIP_LEVEL	3		// VIP3����������ȴ
...
{
	procList.push_back( CM_HALL_OF_FAME_FIGHT );						// ��ս
	procList.push_back( CM_HALL_OF_FAME_BUY_TIMES );					// �������
	procList.push_back( CM_HALL_OF_FAME_CLEAR_CD );						// ��CD
	procList.push_back( CM_HALL_OF_FAME_INFO );							// ���������Ϣ

	procList.push_back( IM_SOCIAL_GAME_HALL_OF_FAME_FIGHT_RESULT );		// ��ս���
	procList.push_back( IM_SOCIAL_GAME_HALL_OF_FAME_GET_REWARD );		// ��ȡ����
	procList.push_back( IM_SOCIAL_GAME_HALL_OF_FAME_RANK_REWARD_INFO );	// ������Ϣ
}
