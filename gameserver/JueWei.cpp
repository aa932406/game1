...
#define  MIN_DONATE_MONEY  3000000		//×îÐ¡¾è¿î
#define  GOLD_TO_MONEY	   10000		//1Ä§Ê¯»»È¡µÄ½ð±ÒÊý
#define  GONG_GAO_CONDITION 10000000	//1000Íò¹«¸æ

enum JueWeiInfo
{
	JUE_WEI_TYPE_KING			= 1,	//Íõ
	JUE_WEI_TYPE_GONG_JUE		= 2,	//¹«¾ô
	JUE_WEI_TYPE_HOU_JUE		= 3,	//ºî¾ô
	JUE_WEI_TYPE_BO_JUE			= 4,	//²®¾ô
	JUE_WEI_TYPE_ZI_JUE			= 5,	//×Ó¾ô
	JUE_WEI_TYPE_XUN_JUE		= 6,	//Ñ«¾ô
	JUE_WEI_TYPE_INVALID		= 7,	//Æ½Ãñ
};
...
int8_t CJueWei::GetJueWei()
{
	...
	if ( !m_FinishLogin )	//Ã»ÓÐÊÕµ½ÖÐÐÄ·þ·¢ÅÅÃû
	{
		return JUE_WEI_TYPE_INVALID;
	}
