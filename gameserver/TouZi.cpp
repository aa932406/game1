...
#define MOON_CARD_NEED_GOLD				 500	//�¿�Ͷ��500
#define MAX_LEVEL_UP_TOU_ZI_COUNT		 10000  //�ȼ�Ͷ�������

enum Record_Typ
{
	MOON_CARD_TOU_ZI		= 1,		//�¿�Ͷ��
	LEVEL_UP_TOU_ZI			= 2,		//�ȼ�Ͷ��
	GET_MOON_CARD_REWARD	= 3,		//��ȡ�¿�Ͷ�ʽ���
	GET_LEVEL_UP_REWARD		= 4,		//��ȡ�ȼ�Ͷ��
};
