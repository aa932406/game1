// Decompiled methods for class: logout_log
// Source: gameserver.cc
// Total methods: 4

#####################################
void __cdecl logout_log::~logout_log(logout_log *const this)
{
  logout_log::~logout_log(this);
  operator delete(this);
}


#####################################
void __cdecl logout_log::CleanUp(logout_log *const this)
{
...
#####################################
void __cdecl logout_log::PackageData(logout_log *const this, Answer::NetPacket *packet)
{
  __int64 v2; // rax
  __int64 v3; // rax
  __int64 v4; // rax
  ...
  Answer::NetPacket::writeInt32(packet, this->logout_time);
...
#####################################
void __cdecl logout_log::UnPackageData(logout_log *const this, Answer::NetPacket *inPacket)
{
  ...
  this->logout_time = Answer::NetPacket::readInt32(inPacket);
