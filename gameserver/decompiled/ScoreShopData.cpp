// Decompiled methods for class: ScoreShopData
// Source: gameserver.cc
// Total methods: 5

#####################################
void __cdecl ScoreShopData::~ScoreShopData(ScoreShopData *const this)
{
  ScoreShopData::~ScoreShopData(this);
  operator delete(this);
}


#####################################
void __cdecl ScoreShopData::SaveToSqlString(
        ScoreShopData *const this,
        ...
        CharId_t nCid)
{
  ...
  bzero(szSQL, 0x1000u);
  snprintf((char *)szSQL, 0xFFFu, "DELETE FROM mem_chr_shop_limit WHERE Cid = %lld AND ShopType=%d", nCid, 3);
...
#####################################
bool __cdecl ScoreShopData::LoadFromDB(
        ScoreShopData *const this,
        ...
        CharId_t nCid)
{
  ...
  bzero(szSQL, 0x1000u);
  snprintf((char *)szSQL, 0xFFFu, "SELECT * FROM `mem_chr_shop_limit` WHERE `Cid`=%lld AND ShopType=%d", nCid, 3);
...
#####################################
void __cdecl ScoreShopData::PackageData(ScoreShopData *const this, Answer::NetPacket *packet)
{
  int first; // edx
  int32_t second; // edx
...
#####################################
void __cdecl ScoreShopData::UnPackageData(ScoreShopData *const this, Answer::NetPacket *inPacket, CharId_t nCid)
{
  int *v3; // rax
