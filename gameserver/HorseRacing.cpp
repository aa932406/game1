...
#define HORSE_RACING_END_MAP_ID					10003		// �յ��ͼ
#define HORSE_RACING_END_POS_X					20			// �յ�����X
#define HORSE_RACING_END_POS_Y					57			// �յ�����Y
#define HORSE_RACING_END_SIZE					6			// �յ������С
#define HORSE_RACING_ACTIVITY_SCORE_RANK_SIZE	3			// ���а��С
#define HORSE_RACING_BOOS_MAP_ID				90017		// BOSS��ͼ
